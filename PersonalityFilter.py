...
def assign_mbti(job_description):
    extroversion = ["communication", "leadership", "teamwork", "sales", "marketing", "public speaking", "team", "collaboration"]
    introversion = ["research", "writing", "analytical", "creative", "strategic", "independently"]
    sensing = ["detail", "practical", "technical", "observational", "efficient", "observant"]
    intuitive = ["creative", "strategic", "innovative", "insightful", "visionary"]
    thinking = ["critical", "solve", "decisive", "strategic", "technical", "problem solving"]
    feeling = ["empathetic", "communication", "resolution", "leadership", "creative"]
    judging = ["planning", "organization", "time management", "decisive", "detail", "accountable"]
    perceiving = ["adaptable", "adaptability", "creative", "problem solving", "solve", "flexible", "exploration"]
...
def main():
    for job in (sort_priority_order(loop_through_jobs(), "INTJ")):
        print(job)
    return
